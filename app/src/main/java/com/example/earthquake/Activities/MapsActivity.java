...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        iconColors=new BitmapDescriptor[]//randomly change marker color
                {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    //get geometry properties
                        ...
                        //Add circle to markers that have magnitude grater than 4
    ...
    public void onMapReady(GoogleMap googleMap)
    {
        ...
        mMap.setOnInfoWindowClickListener(this);//register the click
...
//        Toast.makeText(getApplicationContext(),marker.getTag().toString(),Toast.LENGTH_LONG).show();
    ...
    public void getMoreDetails(String url) //to get data from json from web
    {
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET,
                url, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response)
            {
                ...
                View view=getLayoutInflater().inflate(R.layout.popup,null);//inflates xml class
                ...
                try
                {
                    ...
                    for(int i=0;i<cities.length();i++)
                    {
                        ...
                        +"\n"+ "Distance: "+citiesObj.getString("distance")+" km"
